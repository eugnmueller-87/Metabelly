/* =============================================================
   METABELLY CHAT WIDGET - WPCODE "JavaScript Snippet" (TEST / bottom-LEFT)
   -------------------------------------------------------------
   ASCII-SAFE build: every non-ASCII character (Croatian letters,
   dashes, emoji) is written as a \uXXXX escape so WPCode / security
   plugins / smart-quote filters CANNOT corrupt it. This fixes the
   "Uncaught SyntaxError: Unexpected identifier 'chat'" crash.

   WPCode setup:
     - Code Type : JavaScript Snippet
     - Location  : Site Wide Footer  (Auto Insert)
     - Status    : Active
   Paste EVERYTHING below. Reload, then check the console for:
   [Metabelly chat] ...
   ============================================================= */
(function () {
  'use strict';
  ...
  var CSS = [
    ...
    '#mb-contact-form .mb-form-title{font-weight:600;color:#1e293b;font-size:13px;}',
